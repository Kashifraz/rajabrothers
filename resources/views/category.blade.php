            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 p-4">
                        <form action="{{route('categories.index')}}" method="GET" class="flex items-center  w-full md:w-auto">

                            <label for="table-search" class="sr-only">Search</label>
                            <div class="relative">
                                <input type="text" name="search" value="{{$search}}" id="table-search-users" class="block p-2 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for categories">
                            </div>

                            <x-primary-button class="py-2.5 ml-4" type="submit">
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50 ">
                                <td class="">
                                    <div class="flex items-center my-2 ">
                                        ...
                                        <img class="w-32 h-24 mb-2  ml-5 " src="{{ asset('images/'.$category->image)}}" />
                                        @endif
                                    </div>
                                </td>
    ...
    <div class="py-12 bg-gray-700 hidden transition duration-150 ease-in-out z-10 fixed top-0 right-0 bottom-0 left-0" id="category_modal">
        <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-4xl">
            <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                <h1 class="text-gray-800 font-lg text-2xl font-bold tracking-normal leading-tight mb-4">Add Category</h1>
